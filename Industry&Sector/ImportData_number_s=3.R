...
for (i in 1:nrow(group_industry)) {
  ...
  query_sma_industry <- paste("
                              ...
                              , sum(case when sbt.ew_sent_z < -3 then 1 else 0 end) as sent_tickers_m2
                              , sum(case when sbt.ew_sent_z < -3 then qbt.close_price / qbt.open_price - 1 else 0 end) / sum(case when sbt.ew_sent_z < -2 then 1 else 0 end) as m2_avg_return
                              , sum(case when sbt.ew_sent_z < -1.5 and sbt.ew_sent_z >= -3 then 1 else 0 end) as sent_tickers_m1_m2
                              , sum(case when sbt.ew_sent_z < -1.5 and sbt.ew_sent_z >= -3 then qbt.close_price / qbt.open_price - 1 else 0 end) / sum(case when sbt.ew_sent_z < -1 and sbt.ew_sent_z >= -2 then 1 else 0 end) as m1_m2_avg_return
                              , sum(case when sbt.ew_sent_z <= 1.5 and sbt.ew_sent_z >= -1.5  then 1 else 0 end) as sent_tickers_m1_p1
                              , sum(case when sbt.ew_sent_z <= 1.5 and sbt.ew_sent_z >= -1.5 then qbt.close_price / qbt.open_price - 1 else 0 end) / sum(case when sbt.ew_sent_z <= 1 and sbt.ew_sent_z >= -1 then 1 else 0 end) as m1_p1_avg_return
                              , sum(case when sbt.ew_sent_z > 1.5 and sbt.ew_sent_z <= 3 then 1 else 0 end) as sent_tickers_p1_p2
                              , sum(case when sbt.ew_sent_z > 1.5 and sbt.ew_sent_z <= 3 then qbt.close_price / qbt.open_price - 1 else 0 end) / sum(case when sbt.ew_sent_z > 1 and sbt.ew_sent_z <= 2 then 1 else 0 end) as p1_p2_avg_return
                              , sum(case when sbt.ew_sent_z > 3 then 1 else 0 end) as sent_tickers_p2
                              , sum(case when sbt.ew_sent_z > 3 then qbt.close_price / qbt.open_price - 1 else 0 end) / sum(case when sbt.ew_sent_z > 1 and sbt.ew_sent_z > 2 then 1 else 0 end) as p2_avg_return
