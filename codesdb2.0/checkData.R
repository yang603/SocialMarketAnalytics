checkData <- function(date1, date2){
  ...
  if(date2 == Sys.Date()){
    ...
    smafileout <- paste("C:\\Users\\Ethan\\Documents\\mydata\\results\\sma-RESULTS2.0from",date1,"to",date2,".csv", sep="")
    spyfileout <- paste("C:\\Users\\Ethan\\Documents\\mydata\\results\\spy-RESULTS2.0from",date1,"to",date2,".csv", sep="")
  ...
  fileout <- paste("C:\\Users\\Ethan\\Documents\\mydata\\results\\sma-RESULTS2.0from",date1,"to",date2,".csv", sep="")
  write.table(newList$sma, file=fileout, col.names = TRUE, row.names = FALSE, quote = FALSE, sep=",")
  fileout <- paste("C:\\Users\\Ethan\\Documents\\mydata\\results\\spy-RESULTS2.0from",date1,"to",date2,".csv", sep="")
